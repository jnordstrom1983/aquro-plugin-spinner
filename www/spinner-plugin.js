...
SpinnerPlugin.schedule = function activityStart(labelText, options, timeout, successCallback, failureCallback) {
	...
	exec(successCallback, failureCallback, PLUGIN_ID, "schedule", [labelText, options.dimBackground, timeout]);
};


SpinnerPlugin.cancel = function cancel(successCallback, failureCallback) {


	exec(successCallback, failureCallback, PLUGIN_ID, "cancel", []);
};
